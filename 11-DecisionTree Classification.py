...
rf_classifier=RandomForestClassifier(random_state=0,n_estimators=200,max_depth=10,min_samples_split=5,min_samples_leaf=2)
rf_classifier.fit(x,y)

rf_reg_model=rf_classifier.predict([[6.5]])
rf_reg_model
...
Knn_class_model = KNeighborsClassifier(n_neighbors=2)
Knn_class_model.fit(x,y)
